...
class QuestController extends Controller
{
    ...
    // ==========================
    // QUEST - OPENING (sesuai route /quest/opening)
    // ==========================
    ...
    {
        $items = QuestcardAAnswer::where('user_id', $request->user()->id)
            ->latest()
            ->get();
    ...
    {
        $latest = QuestcardAAnswer::where('user_id', $request->user()->id)
            ->latest()
            ->first();
